...
let package = Package(
	...
	dependencies: [
		...
		.package(url: "https://github.com/eu-digital-identity-wallet/eudi-lib-ios-iso18013-data-transfer.git", exact: "0.6.2"),
		...
		.package(url: "https://github.com/eu-digital-identity-wallet/eudi-lib-ios-statium-swift.git", exact: "0.1.1"),
	...
	targets: [
		...
		.target(
			...
			dependencies: [
				...
				.product(name: "eudi-lib-ios-statium-swift", package: "eudi-lib-ios-statium-swift"),
