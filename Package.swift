...
let package = Package(
	...
	dependencies: [
		...
		.package(url: "https://github.com/eu-digital-identity-wallet/eudi-lib-ios-iso18013-data-transfer.git",  exact: "0.5.8"),
		// .package(path: "../eudi-lib-ios-iso18013-data-model"),
		// .package(path: "../eudi-lib-ios-iso18013-data-transfer"),
		.package(url: "https://github.com/eu-digital-identity-wallet/eudi-lib-ios-wallet-storage.git", exact: "0.4.6"),
